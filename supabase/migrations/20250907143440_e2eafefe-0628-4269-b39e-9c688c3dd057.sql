-- Add 'country' to the page_type options in the seo_settings table
-- First, let's add the country option to any existing enum if it exists
-- If no enum exists, we'll add it as a CHECK constraint enhancement

-- Add sample SEO settings for country pages
