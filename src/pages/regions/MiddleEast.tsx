...
const MiddleEast = () => {
  ...
  useEffect(() => {
    setMeta(
      "Middle East Packages | Explore Middle East Tours",
      "Discover curated Middle East travel packages: luxury, deserts, history. Book Middle East holidays.",
      "/regions/middle-east"
    );
  }, []);

  const packages: TravelPackage[] = useMemo(
    () => (middleEastData as unknown as TravelPackage[]).map(p => ({ ...p, image: regionsImage })),
    []
  );
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="pt-20 mt-6 mb-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <h1 className="text-4xl font-bold text-primary mb-6">Middle East Travel Packages</h1>
