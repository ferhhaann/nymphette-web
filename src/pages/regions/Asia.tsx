...
const Asia = () => {
  ...
  useEffect(() => {
    setMeta(
      "Asia Travel Packages | Explore Asia Tours",
      "Discover curated Asia travel packages: culture, beaches, adventure. Book Asia holidays at great prices.",
      "/regions/asia"
    );
  }, []);

  const packages: TravelPackage[] = useMemo(
    () => (asiaData as unknown as TravelPackage[]).map(p => ({ ...p, image: regionsImage })),
    []
  );
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="pt-20 mt-6 mb-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <h1 className="text-4xl font-bold text-primary mb-6">Asia Travel Packages</h1>
