...
import packages from "./americas.json";
import details from "../countryDetails/americas.json";
...
const americasMerged: UnifiedRegionData = build();
export default americasMerged;
