...
import packages from "./pacificIslands.json";
import details from "../countryDetails/pacific-islands.json";
...
const pacificIslandsMerged: UnifiedRegionData = build();
export default pacificIslandsMerged;
