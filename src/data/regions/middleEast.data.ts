...
import packages from "./middleEast.json";
import details from "../countryDetails/middle-east.json";
...
const middleEastMerged: UnifiedRegionData = build();
export default middleEastMerged;
