  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Title and Description - Above image for mobile */}
          ...
          <div className="hidden sm:block relative z-20 h-full">
            <div className="absolute bottom-4 left-6 right-6">
              <div className="grid grid-cols-1 sm:grid-cols-5 gap-2 sm:gap-3 bg-card/90 backdrop-blur rounded-lg p-3 sm:p-4 shadow">
                <div className="col-span-1 sm:col-span-3"><Input value={query} onChange={(e)=>setQuery(e.target.value)} placeholder="Search city, country or highlight" aria-label="Search" className="text-sm sm:text-base"/></div>
                <div className="col-span-1 sm:col-span-1 bg-card rounded-lg p-2 border">
