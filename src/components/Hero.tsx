...
const Hero = () => {
  ...
  return (
    <div className="relative">
      {/* Hero Image Section */}
      <section className={`relative ${optimizedSettings.mobileLayout.heroHeight || 'h-[80vh] sm:h-[calc(100vh-3rem)]'} w-full flex items-center justify-center overflow-hidden`}>
        {/* Background Image */}
