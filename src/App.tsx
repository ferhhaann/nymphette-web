...
// Create a separate component for routes to access router context
const AppRoutes = () => {
...
const App = () => {
  ...
  const staticProps = typeof window !== 'undefined' ? (window.__STATIC_PROPS__ || {}) : {};
  ...
  const queryClient = useMemo(() => new QueryClient({
    defaultOptions: {
      queries: {
        ...
        retry: typeof window === 'undefined' ? false : 3, // Disable retries during SSR
      },
    },
  }), []);
