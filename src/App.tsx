...
// App provides shared providers (query client, tooltips, toasters). It is router-agnostic.
...
// AppRoutes contains all route definitions and is used by both client and server entries.
